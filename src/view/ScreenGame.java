...
public class ScreenGame extends GameObject {
	...
	public void initResources() {
		...
		_fieldView = new GameFieldView(this.bsGraphics.getSize());
            ...
            BasicBall newball = new BasicBall(field, new Point2D.Double(40, 160), 8.0, new Speed2D(0.03, -0.01));
            ...
            BasicBall ball01 = new BasicBall(field, new Point2D.Double(213.3975, 250), 16.0, new Speed2D(0.043, -0.025));
            BasicBall ball02 = new BasicBall(field, new Point2D.Double(400, 200), 16.0, new Speed2D(-0.05, 0));
